 ...
 * Create the tab
 */
add_action( 'bp_before_activity_type_tab_friends', function() {
?>
 ...
 * Amend the query
 */
add_filter('bp_activity_paged_activities_sql', function($activity_ids_sql) {
    ...
    // Alter ORDER BY
    $activity_ids_sql = preg_replace('/ORDER BY a.date_recorded (DESC|ASC)/', 'ORDER BY GREATEST(c.date_recorded, a.date_recorded) DESC', $activity_ids_sql);
